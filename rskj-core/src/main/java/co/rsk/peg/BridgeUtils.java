...
public class BridgeUtils {
    ...
    public static Script getRedeemScriptFromInput(TransactionInput txInput) {
    ...
    public static Script createBaseInputScriptThatSpendsFromTheFederation(Federation federation, Script customRedeemScript) {
