...
public class BridgeTestNetConstants extends BridgeConstants {
    ...
    BridgeTestNetConstants() {
        ...
        Instant genesisFederationAddressCreatedAt = Instant.ofEpochMilli(1677700426L);
        ...
        numberOfBlocksBetweenPegouts = 2; // 3 hours of RSK blocks (considering 1 block every 30 seconds)
    }
