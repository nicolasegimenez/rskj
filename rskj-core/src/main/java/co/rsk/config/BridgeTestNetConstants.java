...
public class BridgeTestNetConstants extends BridgeConstants {
    ...
    BridgeTestNetConstants() {
        ...
        fundsMigrationAgeSinceActivationBegin = 30L;
        fundsMigrationAgeSinceActivationEnd = 50L;
        specialCaseFundsMigrationAgeSinceActivationEnd = 75L;
        ...
        numberOfBlocksBetweenPegouts = 10; // 3 hours of RSK blocks (considering 1 block every 30 seconds)
    }
