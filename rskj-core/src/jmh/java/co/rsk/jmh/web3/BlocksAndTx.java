...
public class BlocksAndTx {
    ...
    @Benchmark
    public RskWeb3j.GenericJsonResponse rskGetRawTransactionReceiptByHash(BlocksPlan blocksPlan) throws HttpRpcException {
        return blocksPlan.getWeb3Connector().rskGetRawTransactionReceiptByHash(blocksPlan.getTxHash());
    }

    @Benchmark
    public RskWeb3j.GenericJsonResponse rskGetRawTransactionReceiptByBlockHashAndIndex(BlocksPlan blocksPlan) throws HttpRpcException {
        return blocksPlan.getWeb3Connector().rskGetTransactionReceiptNodesByHash(blocksPlan.getBlockHash(), blocksPlan.getTxHash());
    }

    @Benchmark
    public RskWeb3j.GenericJsonResponse rskGetRawBlockHeaderByHash(BlocksPlan blocksPlan) throws HttpRpcException {
        return blocksPlan.getWeb3Connector().rskGetRawBlockHeaderByHash(blocksPlan.getBlockHash());
    }

    @Benchmark
    public RskWeb3j.GenericJsonResponse rskGetRawBlockHeaderByNumber(BlocksPlan blocksPlan) throws HttpRpcException {
